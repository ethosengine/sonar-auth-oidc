...
[![Build Status](https://jenkins.ethosengine.com/job/sonar-auth-oidc/job/2.1.x/badge/icon)](https://jenkins.ethosengine.com/job/sonar-auth-oidc/job/2.1.x/) 
[![Quality Gate](https://sonarqube.ethosengine.com/api/project_badges/measure?project=com.ethosengine.sonarqube.auth.oidc%3Asonar-auth-oidc-plugin&metric=alert_status&token=sqb_e2a24631914d5cd91d4176ba43d50db9a21c20f8)](https://sonarqube.ethosengine.com/dashboard?id=com.ethosengine.sonarqube.auth.oidc%3Asonar-auth-oidc-plugin) [![Release](https://img.shields.io/github/release/ethosengine/sonar-auth-oidc.svg)](https://github.com/ethosengine/sonar-auth-oidc/releases/latest) [![Marketplace](https://img.shields.io/badge/Marketplace-authoidc-orange?logo=SonarQube)](https://www.sonarplugins.com/authoidc) [![Release](https://img.shields.io/github/release/ethosengine/sonar-auth-oidc.svg)](https://github.com/ethosengine/sonar-auth-oidc/releases/latest) [![Marketplace](https://img.shields.io/badge/Marketplace-authoidc-orange?logo=SonarQube)](https://www.sonarplugins.com/authoidc)
